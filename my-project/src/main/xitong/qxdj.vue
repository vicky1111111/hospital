...
<template>
  ...
  <el-col :span="12">
        ...
        <el-table :data="tableData" size="mini" border  style="width: 100%" stripe ref="multipleTable" tooltip-effect="dark"  >
            ...
            <el-table-column :label="label7" prop="ksbh"  >
            </el-table-column>
            ...
            <el-table-column label="编辑" >
                <template slot-scope="scope">
                    <el-button type="primary" icon="el-icon-edit" size="mini"   @click="update(scope.$index, scope.row)">修改权限等级</el-button>
  ...
  <el-col :span="12">
     ...
     <el-col :span="12">
                ...
                <el-form-item :label="label10" prop="qxdj">
                    
						<el-select v-model="VO1.qxdj" placeholder="请选择权限等级"  style="width:100%;">
								<el-option label="管理员权限" value="0"></el-option>
								<el-option label="权限等级1" value="1"></el-option>
								<el-option label="权限等级2" value="2"></el-option>
								<el-option label="权限等级3" value="3"></el-option>
								<el-option label="权限等级4" value="4"></el-option>
						</el-select>
				</el-form-item>
